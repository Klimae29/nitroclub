...
cars = [
  ...
  { style: "muscle", name: "Honda Civic Neon", price: 80, year: 2020, description: "Civic équipée de néons multicolores et kit body.", public_id: "11" },
  { style: "muscle", name: "Toyota Supra Neon", price: 85, year: 2019, description: "Supra avec un éclairage futuriste.", public_id: "12" },
  { style: "muscle", name: "Mitsubishi Eclipse", price: 75, year: 2021, description: "Eclipse, le symbole du tuning japonais.", public_id: "13" },
  { style: "muscle", name: "Volkswagen Golf Sono", price: 100, year: 2016, description: "Golf boostée avec un système audio de compétition.", public_id: "14" },
  { style: "muscle", name: "Peugeot 206 Sono", price: 105, year: 2015, description: "206 avec subwoofers puissants.", public_id: "15" },
  ...
  { style: "stance", name: "Nissan Skyline R34 Neon", price: 110, year: 2018, description: "Skyline avec éclairage sous châssis et néons personnalisés.", public_id: "24" },
  { style: "stance", name: "Hyundai Veloster Neon", price: 85, year: 2021, description: "Une compacte ultra-moderne avec néons LED.", public_id: "25" },
  { style: "stance", name: "Renault Clio Sono", price: 90, year: 2017, description: "Une Clio avec un système audio de compétition.", public_id: "26" },
  { style: "stance", name: "Audi A3 Sono", price: 120, year: 2019, description: "Audi premium avec caissons de basses optimisés.", public_id: "27" },
